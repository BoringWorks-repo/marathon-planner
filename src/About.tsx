    ...
    return <>
        <div className="about-container">
            ...
            <div className="creditblurb">
                <p>*Built on the open-source “Calendar Hack” by <a href="https://github.com/nanreh/calendar-hack">@nanreh</a>. This fork adds a Pace Calculator by Gabriel Wright (BoringWorks)*.</p>
            </div>
        </div>
    </>
}
