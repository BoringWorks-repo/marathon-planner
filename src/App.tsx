...
import PaceWidget from "./components/PaceWidget";
...
// robust "is this a Pfitzinger plan?" check by name/id/source fields
const isPfitz = selectedPlan?.[0]?.startsWith("pfitz_") === true || selectedPlan?.[0]?.startsWith("frr_") === true;
  ...
  <>
      ...
      <div className="second-toolbar">
        <PaceWidget units={selectedUnits} isPfitz={isPfitz}  />
      </div>
